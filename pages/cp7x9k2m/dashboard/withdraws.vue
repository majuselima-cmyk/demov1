<template>
  <div>
    <div class="mb-4 md:mb-6">
      <h1 class="text-xl md:text-2xl font-bold text-gray-900 mb-2">Manajemen Withdraw</h1>
      <p class="text-sm md:text-base text-gray-600">Kelola dan setujui withdraw pengguna</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-4 md:mb-6">
      ...
      <div class="bg-white border border-gray-200 rounded-lg md:rounded-xl p-4 md:p-6 shadow-sm">
        ...
        <p class="text-2xl md:text-3xl font-bold text-green-600">$1,800</p>
        <p class="text-gray-500 text-xs mt-2">8 diproses</p>
      </div>
      <div class="bg-white border border-gray-200 rounded-lg md:rounded-xl p-4 md:p-6 shadow-sm">
        <p class="text-gray-600 text-xs md:text-sm mb-2">Bulan Ini</p>
        <p class="text-2xl md:text-3xl font-bold text-cyan-600">$18,500</p>
        <p class="text-gray-500 text-xs mt-2">95 withdraw</p>
      </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-lg md:rounded-xl shadow-sm overflow-hidden">
      ...
      >
        <template #item-wallet="{ wallet }">
          <p class="text-xs text-gray-600 font-mono">{{ wallet }}</p>
        </template>
...
const items = ref([
  { user: 'alice@example.com', amount: '$200.00', wallet: 'Txxxxxxxxxxxxx', network: 'TRC20', status: 'Tertunda', date: '16 Jan 2024, 11:00' },
  { user: 'charlie@example.com', amount: '$150.00', wallet: '0xxxxxxxxxxxxx', network: 'ERC20', status: 'Memproses', date: '15 Jan 2024, 16:45' },
  { user: 'david@example.com', amount: '$100.00', wallet: 'Txxxxxxxxxxxxx', network: 'TRC20', status: 'Selesai', date: '14 Jan 2024, 09:30' },
  { user: 'emma@example.com', amount: '$300.00', wallet: '0xxxxxxxxxxxxx', network: 'ERC20', status: 'Tertunda', date: '16 Jan 2024, 12:15' },
  { user: 'frank@example.com', amount: '$250.00', wallet: 'Txxxxxxxxxxxxx', network: 'TRC20', status: 'Selesai', date: '15 Jan 2024, 10:20' },
  { user: 'grace@example.com', amount: '$180.00', wallet: '0xxxxxxxxxxxxx', network: 'ERC20', status: 'Memproses', date: '15 Jan 2024, 14:30' },
  { user: 'henry@example.com', amount: '$120.00', wallet: 'Txxxxxxxxxxxxx', network: 'TRC20', status: 'Selesai', date: '14 Jan 2024, 11:45' },
  { user: 'john@example.com', amount: '$400.00', wallet: '0xxxxxxxxxxxxx', network: 'ERC20', status: 'Tertunda', date: '16 Jan 2024, 09:00' }
])
...
const getStatusClass = (status: string) => {
  const classes: Record<string, string> = {
    ...
    'Memproses': 'px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-medium',
